...
<div class="form-group">
 <div class="col-md-3">
  <center>
    ...
    @else
    <img class="thumbnail" src="/uploads/user/{{$edituser->id}}/{{$edituser->pic_id}}" alt="..." height="175px" width="100%">
    @endif
  </center>
...
<div class="col-md-9">
  ...
  <div class="col-md-12">
    <label class="control-label" for="password">Password(Repeated):</label><br>

    <input id="password_confirm" name="password_confirm" value="" class="form-control input-md" type="password" autocomplete="off">
  </div>

  <div class="col-md-4">
    <label class="control-label" for="privilege">Type of User:</label>
    <select id="privilege" name="privilege" class="form-control">
      <option value="Normal User" @if ($edituser->privilege == 'Normal User') selected="selected" @endif>Normal User</option>
      <option value="Administrator" @if ($edituser->privilege == 'Administrator') selected="selected" @endif>Administrator</option>
    </select>
  </div>
